      ...
      <template slot="top_tab">
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane name="first">
            <span slot="label" ><i class="el-icon-tickets"></i> 素材列表</span>
            ...
            <el-table ref="multipleTable" :data="keywordData" border tooltip-effect="dark"  stripe align="center" style="width: 100%">
              <el-table-column label="素材类型"  align="center" prop="keyText" width="110;"></el-table-column>
              <el-table-column label="素材内容" prop="answer">
              ...
              <el-table-column label="素材归属" align="center" prop="" width="110;"></el-table-column>
          ...
          <el-tab-pane name="second">
            <span slot="label" ><i class="el-icon-document"></i> 素材类型列表</span>
            <el-form :inline="true" class="demo-form-inline tableSearchForm">
            ...
            <el-table ref="multipleTable" :data="keywordData" border tooltip-effect="dark"  stripe align="center" style="width: 100%">
              ...
              <el-table-column label="素材类型" prop="answer"></el-table-column>
                <el-table-column label="素材归属" prop="answer"></el-table-column>
                  <el-table-column label="修改时间" prop="answer"></el-table-column>
              <el-table-column align="center" fixed="right" label="操作" width="110">
                   <template slot-scope="scope">
                      <div class="">
          ...
          <el-tab-pane name="third">
            <span slot="label"><i class="el-icon-plus"></i> 新增素材类型</span>

              <el-form ref="form1" :model="form1" :rules="rules1" label-width="100" label-position="left" style="">
                <el-form-item label="素材类型：" prop="talkType">
                ...
                <el-form-item label="类型归属：" prop="sort">
                    <el-select v-model="form1.sort" placeholder="请选择">
                        <el-option label="全部" value=""></el-option>
                        <el-option label="已解决" value="01"></el-option>
                        <el-option label="未解决" value="00"></el-option>
                    </el-select>
          ...
          <el-tab-pane name="fourth">
            <span slot="label"><i class="el-icon-edit-outline"></i> 新增素材</span>
              <el-form ref="form2" :model="form2" :rules="rules2" label-width="100px" label-position="left">
                <el-form-item label="素材归属：" prop="byType">
                ...
                <el-form-item label="素材类型：" prop="byType">
                    <el-select v-model="form2.byType" placeholder="请选择">
                        <el-option label="全部" value=""></el-option>
                        <el-option label="已解决" value="01"></el-option>
                        <el-option label="未解决" value="00"></el-option>
                ...
                <el-form-item label="素材名称：" prop="talkContent">
                  <el-input type="text" v-model="form2.talkContent" ></el-input>
                </el-form-item>
                <el-form-item label="网址链接：">
                  <el-input type="text" v-model="form2.talkContent" ></el-input>
                </el-form-item>
                <el-form-item label="活动详情图：" prop="pushContent" >
                  <MoreImgUpload v-model="form2.picUrl"/>
                  <span style="color:red;font-size:12px;">注：网址和图片只能选择一种，两个都填写将优先展示链接！</span>
                </el-form-item>
                <el-form-item  align="center">
