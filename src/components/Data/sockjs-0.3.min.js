...
function(t) {
    ...
    return function() {
        ...
        {}],
        58 : [function(t, e, n) { (function(n) {
                "use strict";
                function r(t) {
                    t = t || n.location || {};
                    var e, r = {},
                    i = typeof t;
                    if ("blob:" === t.protocol) r = new s(unescape(t.pathname), {});
                    else if ("string" === i) {
                        r = new s(t, {});
                ...
                function s(t, e, n) {
                    ...
                    var a, l, f, h, p, v, m = d.slice(),
                    b = typeof e,
                    y = this,
                    g = 0;
                    for ("object" !== b && "string" !== b && (n = e, e = null), n && "function" != typeof n && (n = c.parse), e = r(e), l = i(t || ""), a = !l.protocol && !l.slashes, y.slashes = l.slashes || a && e.slashes, y.protocol = l.protocol || e.protocol || "", t = l.rest, l.slashes || (m[2] = [/(.*)/, "pathname"]); g < m.length; g++) h = m[g],
                    f = h[0],
                    v = h[1],
                    f !== f ? y[v] = t: "string" == typeof f ? ~ (p = t.indexOf(f)) && ("number" == typeof h[2] ? (y[v] = t.slice(0, p), t = t.slice(p + h[2])) : (y[v] = t.slice(p), t = t.slice(0, p))) : (p = f.exec(t)) && (y[v] = p[1], t = t.slice(0, p.index)),
                    y[v] = y[v] || (a && h[3] ? e[v] || "": ""),
                    h[4] && (y[v] = y[v].toLowerCase());
                    n && (y.query = n(y.query)),
                    a && e.slashes && "/" !== y.pathname.charAt(0) && ("" !== y.pathname || "" !== e.pathname) && (y.pathname = o(y.pathname, e.pathname)),
                    u(y.port, y.protocol) || (y.host = y.hostname, y.port = ""),
                    y.username = y.password = "",
                    y.auth && (h = y.auth.split(":"), y.username = h[0] || "", y.password = h[1] || ""),
                ...
                function a(t, e, n) {
                    ...
                    case "port":
                        r[t] = e,
                        u(e, r.protocol) ? e && (r.host = r.hostname + ":" + e) : (r.host = r.hostname, r[t] = "");
                        break;
                    case "hostname":
                        r[t] = e,
                        r.port && (e += ":" + r.port),
